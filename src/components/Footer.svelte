<footer>
    <div class="container">
        <div class="footer-content">
            <div class="footer-brand">
                ...
                <p class="brand-description">
                    Master AI-powered development with comprehensive courses on Cursor, custom modes, rules, MCPs, and building production-ready applications.
                </p>
        ...
        <div class="footer-bottom">
            <p>&copy; {new Date().getFullYear()} mvpe.fun. All rights reserved.</p>
            <p class="built-with">Built with AI-powered development</p>
        </div>
    </div>
</footer>

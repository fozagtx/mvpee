      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-4">
          <div className="md:col-span-2">
            <div className="text-xl font-bold text-white">Whop Templates</div>
            <p className="mt-2 max-w-md text-gray-400">
              Premium templates for your Whop business. Launch faster, sell more, grow bigger.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><a href="#pricing" className="text-gray-400 transition-colors hover:text-white">Pricing</a></li>
              <li><a href="#" className="text-gray-400 transition-colors hover:text-white">Templates</a></li>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} Whop Templates. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
